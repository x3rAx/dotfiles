...
USAGE="
  Usage:
      yank.sh [OPTIONS] [[file]...]

  OPTIONS:
      -h, --help           Show this help
          --sel            Copy to selection buffer (linux only)
          --sel-fallback   Fall back to clipboard if selection buffer not available
"
...
if [[ $_SEL == false ]] || [[ -z $copy_backend ]] || [[ $_SEL_FALLBACK == true ]]; then
